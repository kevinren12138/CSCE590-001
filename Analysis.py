...
'''
data = pd.read_csv('data/previc/tweetFields.csv')
print(data.shape)
print(data.columns)
data.head(10)
...
data2 = pd.read_csv('data/aftervic/tweetFields.csv')
data.head(10)
...
roc_auc = auc(fpr, tpr)
print('MultinomialNB Training Accuracy::', roc_auc)
...
#print("SVM Training Accuracy Score: ",accuracy_score(train_SVM, y_train)*100)
...
print("Testing Accuracy Score:",accuracy_score(test, y_test)*100)
